...
const widgets = {
  ...
  perceptronLab: () => import('./widgets/PerceptronLab.js').then((m) => m.default),
  neuralNetLab: () => import('./widgets/NeuralNetLab.js').then((m) => m.default),
  convLab: () => import('./widgets/ConvLab.js').then((m) => m.default),
  optimizerLab: () => import('./widgets/OptimizerLab.js').then((m) => m.default),
  crossValLab: () => import('./widgets/CrossValLab.js').then((m) => m.default),
  biasLab: () => import('./widgets/BiasLab.js').then((m) => m.default),
